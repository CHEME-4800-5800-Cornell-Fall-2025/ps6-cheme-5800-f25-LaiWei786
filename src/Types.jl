...
mutable struct MyExperimentalDrugCocktailContext <: MyAbstractContextModel
    ...
    S::Int64               # safety constraint for maximum allowable dosage units: mg/kg-day
    bounds::Array{Float64,2}      # bounds for each drug type (K x 2 matrix, lower and upper bounds)
